...
public class MainActivity extends AppCompatActivity {
    ...
    protected void loadWeatherData(String preferredLocation) {
        URL weatherQuery = NetworkUtils.buildUrl(preferredLocation);
        new NetworkQueryTask().execute(weatherQuery);
    }
