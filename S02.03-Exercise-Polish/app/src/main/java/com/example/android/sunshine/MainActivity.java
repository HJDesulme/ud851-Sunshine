...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDataProgessBar = (ProgressBar) findViewById(R.id.pb_data_fetch);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            mDataProgessBar.setVisibility(View.VISIBLE);
        }
        ...
        protected String[] doInBackground(String... params) {
            ...
            if (params.length == 0) {
                return null; //passed into (String[] weatherData) | null
            }
            ...
            try {
                ...
                return simpleJsonWeatherData; //passed into (String[] weatherData) | not null
